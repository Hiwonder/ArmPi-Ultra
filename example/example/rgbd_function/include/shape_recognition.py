...
class ObjectClassificationNode(Node):
    hand2cam_tf_matrix = [
        [-0.04805585600236917, -0.04461395198128315, 0.9894943197004222,  -0.09492810001641333],  # x
        [-0.9978265270878439, 0.047238566599645315, -0.045942786870444285, 0.005512192972803422],  # y
        [-0.04508721042259933, -0.9978868238002858, -0.046787074519418326, 0.029782226823313062],  # z
        [0.0, 0.0, 0.0, 1.0]
    ]
    pick_offset = [-0.02, 0.02, 0.01, 0.0, 0.0]  # x1, x2, y1, y2, z
    '''
